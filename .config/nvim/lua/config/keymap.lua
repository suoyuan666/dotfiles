...
map("n", "<Space>ff", "<cmd>:FzfLua files<cr>", opts)
map("n", "<Space>fof", "<cmd>FzfLua oldfiles<cr>", opts)
map("n", "<Space>sg", "<cmd>FzfLua live_grep<cr>", opts)
map("n", "<Space>gc", "<cmd>FzfLua git_commits<cr>", opts)
map("n", "<Space>gs", "<cmd>FzfLua git_status<cr>", opts)
map("n", "<Space>cd", "<cmd>FzfLua diagnostics_document<cr>", opts)
map("n", "<Space>cld", "<cmd>FzfLua lsp_definitions<cr>", opts)
map("n", "<Space>clr", "<cmd>FzfLua lsp_references<cr>", opts)
map("n", "<Space>clk", "<cmd>FzfLua lsp_document_symbols<cr>", opts)
map("n", "<Space>clic", "<cmd>FzfLua lsp_incoming_calls<cr>", opts)
map("n", "<Space>cloc", "<cmd>FzfLua lsp_outgoing_calls<cr>", opts)
